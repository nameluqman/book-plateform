...
const QuranTafaseers = () => {
  let books = localStorage.getItem("books");
  let Books = JSON.parse(books);
  let quranTafaseer = Books?.filter((book) => book.subcategory === "Tafseer");
          ...
          {quranTafaseer?.map((book) => (
            ...
            >
              ...
              <div className="my-3 2xl:mt-6 px-2">
                <h1 className="2xl:text-3xl text-lg font-semibold 2xl:h-[65px] h-[50px] overflow-hidden  ">
                  {book.name}
                </h1>
