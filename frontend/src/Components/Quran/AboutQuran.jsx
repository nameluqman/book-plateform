...
const AboutQuran = () => {
  ...
  let aboutQuran = Books?.filter((book) => book.subcategory === "About Quran");
    ...
    <div className="md:px-4 px-2 md:mt-12  mt-4 pb-12">
      <div className="border md:p-5 p-2 rounded shadow ">
        <div className="flex items-center justify-between p-3">
          <h1 className="md:text-2xl text-xl font-bold">About Quran Books</h1>
          <p className="text-lg text-gray-500">{aboutQuran?.length} books</p>
        </div>
        ...
        <div className="grid 2xl:grid-cols-5 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-10 md:gap-12 gap-10  mt-3 pb-6">
          {aboutQuran?.map((book) => (
            <div
              className="shadow-lg border border-gray-700 lg:hover:scale-105 duration-500 ease-in-out bg-gray-200  rounded-lg cursor-pointer"
            ...
            >
              ...
              <div className="my-3 2xl:mt-6 px-2">
                <h1 className="2xl:text-3xl text-xl font-semibold 2xl:h-[65px] h-[55px] overflow-hidden  ">
                  {book.name}
                </h1>
