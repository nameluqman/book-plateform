...
const QuranBook = () => {
  ...
  let quranBook = Books?.filter((book) => book.subcategory === "Quran");
    ...
    <div className="md:px-4 px-2 md:mt-12  mt-4 pb-12">
      <div className="border md:p-5 p-2 rounded shadow ">
        <div className="flex items-center justify-between p-3">
          <h1 className="text-2xl font-bold">Quran Mushaf</h1>
          <p className="text-lg text-gray-500">{quranBook?.length} books</p>
        </div>
          ...
          {quranBook?.map((book) => (
            ...
            >
              ...
              <div className="my-3 2xl:mt-6 px-2">
                <h1 className="2xl:text-3xl text-xl font-semibold  ">
                  {book.name}
                </h1>
