    ...
    <div className="md:px-4 px-2 md:mt-12  mt-4 pb-12">
      <div className="border md:p-5 p-2 rounded shadow ">
        ...
        <div className="grid 2xl:grid-cols-5 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-10 md:gap-12 gap-10  mt-3 pb-6">
          {books?.map((book) => (
            <div
              className="boxShadow border border-gray-700 lg:hover:scale-105 duration-500 ease-in-out bg-gray-200  rounded-lg cursor-pointer"
              onClick={() => handleBook(book)}
            >
              <div className="w-full 2xl:h-[430px] h-[260px]  bg-white border-b border-black rounded-t-lg ">
                <img
                  src={book.img}
              ...
              <div className="my-3 2xl:mt-6 px-2">
                <h1
                  className={`2xl:text-3xl text-lg font-semibold`}
                >
