...
const SunanNasai = () => {
  ...
  let sunanNasai = Books?.filter((book) => book.subcategory === "Sunan Nasai");
    ...
    <div className="md:px-4 px-2 md:mt-12  mt-4 pb-12">
      <div className="border md:p-5 p-2 rounded shadow ">
        <div className="flex items-center justify-between p-3">
          <h1 className="text-2xl font-bold uppercase ">Sunan Nasai</h1>
          <p className="text-lg text-gray-500">{sunanNasai?.length} books</p>
        </div>
          ...
          {sunanNasai?.map((book) => (
            ...
            >
              ...
              <div className="my-3 2xl:mt-6 px-2">
                <h1 className="2xl:text-3xl text-xl font-semibold  overflow-hidden  ">
                  {book.name}
                </h1>
